...
class PublicDataClient(
    ...
    private fun setSecretKey(queryParam: MultiValueMap<String, String>?): MultiValueMap<String, String> {
        return queryParam?.apply { add("ServiceKey", URLEncoder.encode(secretKey, "UTF-8")) }
            ?: LinkedMultiValueMap<String, String>().apply { add("ServiceKey", URLEncoder.encode(secretKey, "UTF-8")) }
    }
}
