...
class PublicDataController(
    ...
    fun getInfection(
        ...
        return InfectionRes.from(publicDataService.getInfection(date ?: LocalDate.now()))
    }
    ...
    fun getInfectionRegion(
        ...
        return InfectionRegionRes.from(publicDataService.getInfectionRegion(date ?: LocalDate.now()))
    }
